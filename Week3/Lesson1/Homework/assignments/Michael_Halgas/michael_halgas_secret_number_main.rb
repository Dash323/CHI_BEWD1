...
require_relative 'lib/michael_halgas_secret_number_get_player_name.rb'
require_relative 'lib/michael_halgas_secret_number_game.rb'

puts "******************Welcome to Secret Number Game****************** \n \n"
puts "                 Game Developed by Michael Halgas                 \n \n"
...
#try = 3
#while try >  
#	do_guess = game.start_game
#	try -= 1
	#puts "You have #{try} attempts remaining."
#end

puts "Good game #{player_name.name}. Try again another day."
